[libui-ktx](../../index.md) / [kotlinx.cinterop](../index.md) / [Arena](./index.md)

# Arena

`class Arena : `[`ArenaBase`](../-arena-base/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Arena(parent: `[`NativeFreeablePlacement`](../-native-freeable-placement/index.md)` = nativeHeap)` |
