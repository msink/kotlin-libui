[libui-ktx](../../index.md) / [kotlinx.cinterop](../index.md) / [ArenaBase](./index.md)

# ArenaBase

`open class ArenaBase : `[`AutofreeScope`](../-autofree-scope/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `ArenaBase(parent: `[`NativeFreeablePlacement`](../-native-freeable-placement/index.md)` = nativeHeap)` |
...
| Name | Summary |
|---|---|
| [Arena](../-arena/index.md) | `class Arena : `[`ArenaBase`](./index.md) |
| [MemScope](../-mem-scope/index.md) | `class MemScope : `[`ArenaBase`](./index.md) |
