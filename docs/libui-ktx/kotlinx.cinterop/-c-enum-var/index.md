[libui-ktx](../../index.md) / [kotlinx.cinterop](../index.md) / [CEnumVar](./index.md)

# CEnumVar

`abstract class CEnumVar : `[`CPrimitiveVar`](../-c-primitive-var/index.md)

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `CEnumVar(rawPtr: `[`NativePtr`](../-native-ptr.md)`)` |
