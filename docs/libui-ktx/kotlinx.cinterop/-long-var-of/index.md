[libui-ktx](../../index.md) / [kotlinx.cinterop](../index.md) / [LongVarOf](./index.md)

# LongVarOf

`class LongVarOf<T : `[`Long`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html)`> : `[`CPrimitiveVar`](../-c-primitive-var/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `LongVarOf(rawPtr: `[`NativePtr`](../-native-ptr.md)`)` |
...
| [value](../value.md) | `var <T : `[`Long`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html)`> `[`LongVarOf`](./index.md)`<`[`T`](../value.md#T)`>.value: `[`T`](../value.md#T) |
