[libui-ktx](../../index.md) / [kotlinx.cinterop](../index.md) / [BooleanVarOf](./index.md)

# BooleanVarOf

`class BooleanVarOf<T : `[`Boolean`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)`> : `[`CPrimitiveVar`](../-c-primitive-var/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `BooleanVarOf(rawPtr: `[`NativePtr`](../-native-ptr.md)`)` |
...
| [value](../value.md) | `var <T : `[`Boolean`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)`> `[`BooleanVarOf`](./index.md)`<`[`T`](../value.md#T)`>.value: `[`T`](../value.md#T) |
