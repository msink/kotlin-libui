[libui-ktx](../../index.md) / [kotlinx.cinterop](../index.md) / [DoubleVarOf](./index.md)

# DoubleVarOf

`class DoubleVarOf<T : `[`Double`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-double/index.html)`> : `[`CPrimitiveVar`](../-c-primitive-var/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `DoubleVarOf(rawPtr: `[`NativePtr`](../-native-ptr.md)`)` |
...
| [value](../value.md) | `var <T : `[`Double`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-double/index.html)`> `[`DoubleVarOf`](./index.md)`<`[`T`](../value.md#T)`>.value: `[`T`](../value.md#T) |
