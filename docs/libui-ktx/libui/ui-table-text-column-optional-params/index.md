[libui-ktx](../../index.md) / [libui](../index.md) / [uiTableTextColumnOptionalParams](./index.md)

# uiTableTextColumnOptionalParams

`class uiTableTextColumnOptionalParams : `[`CStructVar`](../../kotlinx.cinterop/-c-struct-var/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `uiTableTextColumnOptionalParams(rawPtr: `[`NativePtr`](../../kotlinx.cinterop/-native-ptr.md)`)` |
