[libui-ktx](../../index.md) / [libui](../index.md) / [uiTableParams](./index.md)

# uiTableParams

`class uiTableParams : `[`CStructVar`](../../kotlinx.cinterop/-c-struct-var/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `uiTableParams(rawPtr: `[`NativePtr`](../../kotlinx.cinterop/-native-ptr.md)`)` |
