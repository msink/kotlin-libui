[libui-ktx](../../index.md) / [libui](../index.md) / [uiInitOptions](./index.md)

# uiInitOptions

`class uiInitOptions : `[`CStructVar`](../../kotlinx.cinterop/-c-struct-var/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `uiInitOptions(rawPtr: `[`NativePtr`](../../kotlinx.cinterop/-native-ptr.md)`)` |
