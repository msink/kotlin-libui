[libui-ktx](../../index.md) / [libui](../index.md) / [Checkbox](./index.md)
...
| [&lt;init&gt;](-init-.md) | `Checkbox(label: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`)` |
...
| [label](../label.md) | `var `[`Checkbox`](./index.md)`.label: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)<br>The static text of the checkbox. |
| [value](../value.md) | `var `[`Checkbox`](./index.md)`.value: `[`Boolean`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)<br>Whether the checkbox is checked or unchecked. Defaults to `false`. |

### Extension Functions

| [action](../action.md) | `fun `[`Checkbox`](./index.md)`.action(block: `[`Checkbox`](./index.md)`.() -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)<br>Function to be run when the user clicks the Checkbox. Only one function can be registered at a time. |
