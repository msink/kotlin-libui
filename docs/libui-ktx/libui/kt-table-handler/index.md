[libui-ktx](../../index.md) / [libui](../index.md) / [ktTableHandler](./index.md)

# ktTableHandler

`class ktTableHandler : `[`CStructVar`](../../kotlinx.cinterop/-c-struct-var/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `ktTableHandler(rawPtr: `[`NativePtr`](../../kotlinx.cinterop/-native-ptr.md)`)` |
