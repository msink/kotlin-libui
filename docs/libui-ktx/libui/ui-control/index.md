...
| [Handle](-handle.md) | `var Handle: `[`CPointer`](../../kotlinx.cinterop/-c-pointer/index.md)`<`[`CFunction`](../../kotlinx.cinterop/-c-function/index.md)`<(`[`CPointer`](../../kotlinx.cinterop/-c-pointer/index.md)`<`[`uiControl`](./index.md)`>?) -> <ERROR CLASS>>>?` |
...
| [OSSignature](-o-s-signature.md) | `var OSSignature: <ERROR CLASS>` |
...
| [Signature](-signature.md) | `var Signature: <ERROR CLASS>` |
...
| [TypeSignature](-type-signature.md) | `var TypeSignature: <ERROR CLASS>` |
