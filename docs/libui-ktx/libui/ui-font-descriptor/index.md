[libui-ktx](../../index.md) / [libui](../index.md) / [uiFontDescriptor](./index.md)

# uiFontDescriptor

`class uiFontDescriptor : `[`CStructVar`](../../kotlinx.cinterop/-c-struct-var/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `uiFontDescriptor(rawPtr: `[`NativePtr`](../../kotlinx.cinterop/-native-ptr.md)`)` |

### Properties

| Name | Summary |
|---|---|
| [Family](-family.md) | `var Family: `[`CPointer`](../../kotlinx.cinterop/-c-pointer/index.md)`<`[`ByteVar`](../../kotlinx.cinterop/-byte-var.md)`>?` |
