...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `VBox()`<br>Wrapper class for [uiBox](../../libui/ui-box.md) that stack its children vertically. |
...
| [separator](../separator.md) | `fun `[`VBox`](./index.md)`.separator(init: `[`HorizontalSeparator`](../-horizontal-separator/index.md)`.() -> Unit = {}): `[`HorizontalSeparator`](../-horizontal-separator/index.md)<br>An horizontal line to visually separate widgets. |
...
| [vbox](../vbox.md) | `fun `[`Container`](../-container/index.md)`.vbox(padded: Boolean = true, init: `[`VBox`](./index.md)`.() -> Unit = {}): `[`VBox`](./index.md)<br>A container that stack its children vertically. |
