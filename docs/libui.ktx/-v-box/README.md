...
| [separator](../separator.md) | `fun VBox.separator(init: `[`HorizontalSeparator`](../-horizontal-separator/README.md)`.() -> Unit = {}): `[`HorizontalSeparator`](../-horizontal-separator/README.md)<br>DSL builder for an horizontal line to visually separate widgets. |
...
| [vbox](../vbox.md) | `fun `[`Container`](../-container/README.md)`.vbox(padded: Boolean = true, init: VBox.() -> Unit = {}): `[`VBox`](README.md)<br>DSL builder for a container that stack its children vertically. |
