...
| [vbox](../vbox.md) | `val `[`Container`](../-container/README.md)`.vbox: `[`VBox`](README.md)<br>DSL builder for a container that stack its children vertically. |
...
| [separator](../separator.md) | `fun `[`VBox`](README.md)`.separator(init: `[`HorizontalSeparator`](../-horizontal-separator/README.md)`.() -> Unit = {}): `[`HorizontalSeparator`](../-horizontal-separator/README.md)<br>DSL builder for an horizontal line to visually separate widgets. |
...
| [vbox](../vbox.md) | `fun `[`Container`](../-container/README.md)`.vbox(padded: Boolean = true, init: `[`VBox`](README.md)`.() -> Unit = {}): `[`VBox`](README.md)<br>DSL builder for a container that stack its children vertically. |
