...
`class GridPane : `[`Control`](../-control/index.md)`<`[`uiGrid`](../../libui/ui-grid.md)`>, `[`Container`](../-container/index.md)
...
| Name | Summary |
|---|---|
| [add](add.md) | `fun <T : `[`Control`](../-control/index.md)`<*>> add(widget: `[`T`](add.md#T)`): `[`T`](add.md#T)<br>Adds the given widget to the end of the form. |
| [insert](insert.md) | `fun insert(widget: `[`Control`](../-control/index.md)`<*>, existing: `[`Control`](../-control/index.md)`<*>, at: `[`uiAt`](../../libui/ui-at.md)`): Unit`<br>Insert the given Control after existing Control. |
...
| [gridpane](../gridpane.md) | `fun `[`Container`](../-container/index.md)`.gridpane(padded: Boolean = true, init: `[`GridPane`](./index.md)`.() -> Unit = {}): `[`GridPane`](./index.md)<br>DSL builder for a powerful container that allow to specify size and position of each children. |
