...
`class Form : `[`Control`](../-control/index.md)`<`[`uiForm`](../../libui/ui-form.md)`>, `[`Container`](../-container/index.md)
...
| [form](../form.md) | `fun `[`Container`](../-container/index.md)`.form(padded: Boolean = true, init: `[`Form`](./index.md)`.() -> Unit = {}): `[`Form`](./index.md)<br>DSL builder for a container that organize children as labeled fields. |
