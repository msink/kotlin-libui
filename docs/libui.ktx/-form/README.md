...
| [form](../form.md) | `fun `[`Container`](../-container/README.md)`.form(padded: Boolean = true, init: `[`Form`](README.md)`.() -> Unit = {}): `[`Form`](README.md)<br>DSL builder for a container that organize children as labeled fields. |
