...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Slider(min: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`, max: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`)`<br>Wrapper class for [uiSlider](../../libui/ui-slider.md) |
