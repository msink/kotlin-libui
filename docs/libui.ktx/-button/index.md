[libui.ktx](../index.md) / [Button](./index.md)
...
| Name | Summary |
|---|---|
| [action](action.md) | `fun action(block: `[`Button`](./index.md)`.() -> Unit): Unit`<br>Function to be run when the user clicks the Button. Only one function can be registered at a time. |
