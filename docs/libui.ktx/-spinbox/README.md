...
| Name | Summary |
|---|---|
| [action](action.md) | `fun action(block: `[`Spinbox`](README.md)`.() -> Unit)`<br>Function to be run when the user makes a change to the Spinbox. Only one function can be registered at a time. |
