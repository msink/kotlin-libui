...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `TextArea(wrap: `[`Boolean`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)` = true)`<br>Wrapper class for [uiMultilineEntry](../../libui/ui-multiline-entry.md) |
