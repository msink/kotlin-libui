...
| Name | Summary |
|---|---|
| [add](add.md) | `fun add(label: String, widget: `[`Control`](../-control/index.md)`<*>): Unit`<br>Adds the given page to the end of the TabPane. |
...
| [insert](insert.md) | `fun insert(page: Int, name: String, widget: `[`Control`](../-control/index.md)`<*>): Unit`<br>Adds the given page to the TabPane such that it is the nth page of the TabPane (starting at 0). |
...
| Name | Summary |
|---|---|
| [page](../page.md) | `fun `[`TabPane`](./index.md)`.page(label: String, margined: Boolean = true, init: `[`Page`](-page/index.md)`.() -> Unit = {}): `[`Page`](-page/index.md) |
