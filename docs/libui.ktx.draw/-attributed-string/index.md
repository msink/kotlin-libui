[libui.ktx.draw](../index.md) / [AttributedString](./index.md)

# AttributedString

`class AttributedString : `[`Disposable`](../../libui.ktx/-disposable/index.md)`<`[`uiAttributedString`](../../libui/ui-attributed-string.md)`>`
