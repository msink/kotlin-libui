...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `UnderlineColorAttribute(kind: `[`uiUnderlineColor`](../../libui/ui-underline-color.md)`, color: `[`Color`](../-color/README.md)`)`<br>Changes the color of the underline on the text it is applied to. |
